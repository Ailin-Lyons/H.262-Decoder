...
#ifndef PROJECT_CODE_PROGRAMASSOSCIATIONSECTION_H
#define PROJECT_CODE_PROGRAMASSOSCIATIONSECTION_H


#include "TSPayloadSections.h"

class ProgramAssosciationSection {
    struct pas_program {
...
#endif //PROJECT_CODE_PROGRAMASSOSCIATIONSECTION_H
