...
//        }
        ...
        if (peek(1) == 1) {
            ...
            while (peek(1) == 1) {
                read(1);
                extra_Information = (SlicePacket::extraInformation*) realloc(extra_Information, sizeof(SlicePacket::extraInformation)*(numExtraInfo+1));
        ...
        //TODO macroblock
        return new SlicePacket(SlicePacket::initializerStruct{stream_id, slice_start_code, slice_vertical_position_extension,
