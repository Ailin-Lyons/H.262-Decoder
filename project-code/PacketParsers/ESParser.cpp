...
public:
    ...
    */
    ...
    /**
     * Parses the data field from tp into individual Elementary Stream Packets.
    ...
    static pes_packet_array ParseTransportPacketData(TransportPacket *tp) {
        //TODO refactor to take no input (get it from TSParser as needed) and output a single ESPacket
