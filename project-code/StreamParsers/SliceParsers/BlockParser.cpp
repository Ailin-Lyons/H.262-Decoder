...
BlockParser::vlc_signed BlockParser::table_b14[] = {{0b1, 0, 1, 1},
                                                    {0b11, 0, 1, 2},
                                                    {0b011, 1, 1, 3},
                                                    {0b0100, 0, 2, 4},
                                                    {0b0101, 2, 1, 4},
                                                    ...
                                                    {0b0000111, 8, 1, 7},
                                                    {0b0000101, 9, 1, 7},
                                                    {0b000001, CHAR_MAX, CHAR_MAX, 6}, // treat as special
                                                    {0b00100110, 0, 5, 8},
                                                    {0b00100001, 0, 6, 8},
                                                    {0b00100101, 1, 3, 8},
                                                    {0b00100100, 3, 2, 8},
...
BlockParser::vlc_signed BlockParser::table_b15[] = {{0b10, 0, 1, 2},
                                                    ...
                                                    {0b0000101, 8, 1, 7},
                                                    {0b1111000, 9, 1, 7},
                                                    {0b000001, CHAR_MAX, CHAR_MAX, 6}, // special case
                                                    {0b11101, 0, 5, 5},
                                                    {0b000101, 0, 6, 6},
                                                    {0b1111001, 1, 3, 7},
                                                    {0b00100110, 3, 2, 8},
...
BlockParser::vlc_signed BlockParser::table_b16[] = {};
...
Block *BlockParser::block(size_t i) {
    ...
    init.dct_coefficients = (int*) malloc(sizeof(int) * 64);
    ...
    if (pattern_code[i]) {
        if (pictureDecoder->isMacroblockIntra()) {
            ...
            //TODO - First DCT coefficient
            throw PacketException("TODO - implement the function");
        }
        //TODO - redesign
        while (((!tableFlag && peek(2) != 0b10) || (tableFlag && peek(4) != 0b0110)) && init.num_dct_coefficients < 64) {
            init.dct_coefficients[init.num_dct_coefficients++] = doAcCoefficients(tableFlag);
        }
...
int BlockParser::doAcCoefficients(bool tableFlag) {
