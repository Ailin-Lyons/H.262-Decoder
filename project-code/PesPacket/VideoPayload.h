...
#ifndef PROJECT_CODE_VIDEOPAYLOAD_H
...
public:
    ...
    struct PES_extension_fields {
        ...
        //VideoPayload::PackHeader pack_header; //TODO make a struct
    ...
    PESPacket::start_code payload_type = PESPacket::start_code::video_stream;
...
#endif //PROJECT_CODE_VIDEOPAYLOAD_H
